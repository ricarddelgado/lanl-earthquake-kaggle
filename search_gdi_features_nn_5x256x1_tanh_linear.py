...
param_list_gdi = pd.read_csv('../tmp_results/parameters_list_gdi.txt')
...
tiny_nn_results_file = "../output/search_gdi_features_nn_5x256x1_tanh_linear/small_nn_search_{}.csv".format(str(datetime.datetime.now()))
