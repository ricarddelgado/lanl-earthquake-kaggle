...
from features import create_all_features_extended
...
X_tr.to_hdf('../tmp_results/Xv3_tr.hdf', 'data')
X_test.to_hdf('../tmp_results/Xv3_test.hdf', 'data')
y_tr.to_hdf('../tmp_results/yv3_tr.hdf', 'data')
